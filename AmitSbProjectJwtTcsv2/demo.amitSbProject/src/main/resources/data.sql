...
insert into My_User (username, password) values ('jack', 'pass_word');
insert into MY_USER (USERNAME, "PASSWORD") values ('bob', 'pass_word');
insert into my_user (username, password) values ('apple', 'pass_word');
insert into my_user (username, password) values ('glaxo', 'pass_word');
